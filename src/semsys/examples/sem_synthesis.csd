...
#define MODEL_DIR # "/Users/pm/AcaHub/Coding/csound-repo/semsys-models/all-MiniLM-L6-v2/all-MiniLM-L6-v2-e2e" # ; end-to-end embedding model dir: must contain model.onnx + model.onnx.data
