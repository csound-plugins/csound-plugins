...
kfreq, kconfidence, kvoiced pyin asig, iminfreq=60, imaxfreq=1000, ibufsize=2048, ioverlap=4, ktransprob=0.99, ibins=360, kdrift=5 

Args:
	* asig: audio signal
	* iminfreq: min. frequency for f0
	* imaxfreq: max. frequency for f0
	* ibufsize: size of the analysis frame
	* ioverlap: overlapping frames. hopsize=bufsize/overlap
	* ktransprob: hmm transition probability
	* kdrift: pitch drift between frames, in semitones
...
instr 1
  ...
  kpitch, kconf, kvoiced pyin asig, 60, 1000, 2048, 4, 0.992, 480
