...
# The output path for the plugins
...
function(add_csound_plugin PROJECT_NAME PLUGIN_NAME PLUGIN_SOURCES)
  ...
  set_target_properties(${PROJECT_NAME} PROPERTIES LIBRARY_OUTPUT_DIRECTORY ${CSOUND_OUTPUT_PATH})
  set_target_properties(${PROJECT_NAME} PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${CSOUND_OUTPUT_PATH})
  set_target_properties(${PROJECT_NAME} PROPERTIES ARCHIVE_OUTPUT_DIRECTORY ${CSOUND_OUTPUT_PATH})
...
macro(set_csound_plugins_path PLUGIN_PATH)
  set(CSOUND_OUTPUT_PATH ${PLUGIN_PATH})
endmacro(set_csound_plugins_path)
